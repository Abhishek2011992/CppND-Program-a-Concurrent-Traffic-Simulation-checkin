...
void TrafficLight::waitForGreen()
{
    ...
    while(1){
      TrafficLightPhase status = _msg_queue.receive();
      if(TrafficLightPhase::green==status){
          break;
      }
    }
}
...
void TrafficLight::cycleThroughPhases()
{
    ...
    while(1){
        ...
        if(updatetime > distribution(generator)){
            starttime = std::chrono::system_clock::now();
            _currentPhase = (TrafficLightPhase)((bool)_currentPhase ^1);  
